...
public class ActuatorController {
	...
	public static final int MAX_NEUTRAL_CONTOUR_AREA = 1950;
	...
	public class IRSensors {
		double _frontLeftIRVoltage, _frontRightIRVoltage, _frontCenterIRVoltage;// , _leftSideIRVoltage, _rightSideIRVoltage;
		...
		public void updateIRSensorsVoltage(float frontLeftIRVoltage, float frontRightIRVoltage, float frontCenterIRVoltage) {
			_frontLeftIRVoltage = frontLeftIRVoltage;
			_frontRightIRVoltage = frontRightIRVoltage;
			_frontCenterIRVoltage = frontCenterIRVoltage;
		}
	}
